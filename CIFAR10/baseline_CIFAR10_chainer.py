...
#D = 32
num_outputs = 10
#num_conv1_outputs_per_channel =  ( (D-8)/4+1 )*( (D-8)/4+1 )
#D1 = int(np.sqrt(num_conv1_outputs_per_channel))
#num_conv2_outputs_per_channel =  ( (D1-4)/2+1 )*( (D1-4)/2+1 )
#num_ReLU_layer_inputs = 16*num_conv2_outputs_per_channel
#num_ReLU_layer_inputs = 6400


#this model is the VGG model from https://github.com/mitmul/chainer-cifar10
